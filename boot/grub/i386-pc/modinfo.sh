...
# Build environment
grub_target_cc='i686-linux-gnu-gcc'
grub_target_cc_version='i686-linux-gnu-gcc (Debian 8.3.0-7) 8.3.0'
...
grub_target_cppflags=' -Wall -W  -DGRUB_MACHINE_PCBIOS=1 -DGRUB_MACHINE=I386_PC -m32 -nostdinc -isystem /usr/lib/gcc-cross/i686-linux-gnu/8/include -I$(top_srcdir)/include -I$(top_builddir)/include'
...
grub_ccasflags=''
grub_ldflags=''
grub_target_strip='i686-linux-gnu-strip'
grub_target_nm='i686-linux-gnu-nm'
grub_target_ranlib='i686-linux-gnu-ranlib'
grub_target_objconf=''
grub_target_obj2elf=''
