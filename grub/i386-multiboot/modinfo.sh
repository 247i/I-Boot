...
# Build environment
grub_target_cc='gcc'
grub_target_cc_version='gcc (Ubuntu 7.5.0-3ubuntu1~18.04) 7.5.0'
...
grub_target_cppflags=' -Wall -W  -DGRUB_MACHINE_MULTIBOOT=1 -DGRUB_MACHINE=I386_MULTIBOOT -m32 -nostdinc -isystem /usr/lib/gcc/x86_64-linux-gnu/7/include -I$(top_srcdir)/include -I$(top_builddir)/include'
