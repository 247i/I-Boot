...
; Acronis True Image 
 ...
 ; Linux Kid X
  ...
  ${ElseIf} $DistroName == "CentOS Installer"
	 ...
	 ${WriteToFile} "#start $JustISOName$\r$\nlabel $JustISOName$\r$\nMENU LABEL $JustISOName$\r$\nMENU INDENT 1$\r$\nKERNEL /multiboot/grub.exe$\r$\nAPPEND --config-file=root (hd0,0);configfile /multiboot/$JustISOName/basic.lst$\r$\n#end $JustISOName" $R0   
  ...
  ${ElseIf} $DistroName == "Bluestar Linux"
	 ...
	 CopyFiles $ISOFile "$BootDir\multiboot\$JustISOName\$JustISO" 
	 ${WriteToFile} "#start $JustISOName$\r$\nlabel $JustISOName$\r$\nMENU LABEL $JustISOName$\r$\nMENU INDENT 1$\r$\nKERNEL /multiboot/grub.exe$\r$\nAPPEND --config-file=root (hd0,0);configfile /multiboot/$JustISOName/$JustISOName.lst$\r$\n#end $JustISOName" $R0   
	 File /oname=$PLUGINSDIR\basic.lst "Menu\basic.lst"  
  ...
  ${ElseIf} $DistroName == "HD Sentinel (HDD Diagnostics)"
	 ...
	 ${WriteToFile} "#start $JustISOName$\r$\nlabel $JustISOName$\r$\nMENU LABEL $JustISOName$\r$\nMENU INDENT 1$\r$\nKERNEL /multiboot/grub.exe$\r$\nAPPEND --config-file=root (hd0,0);configfile /multiboot/$JustISOName/customram.lst$\r$\n#end $JustISOName" $R0   
  ...
  ${ElseIf} $DistroName == "Ubuntu" 
    ...
    ; ${OrIf} $DistroName == "Debian Live"
		...
		${WriteToFile} "#start $JustISOName$\r$\nlabel $JustISOName$\r$\nmenu label $JustISOName$\r$\nMENU INDENT 1$\r$\nKERNEL /multiboot/grub.exe$\r$\nAPPEND --config-file=root (hd0,0);configfile /multiboot/$JustISOName/ubuntu.lst$\r$\n#end $JustISOName" $R0   
	  ...
	  ${Else}
	   ...
	   ${If} ${FileExists} "$BootDir\multiboot\$JustISOName\vmlinuz.efi"
	   !insertmacro ReplaceInFile "VLUG" "vmlinuz.efi fsck.mode=skip" "all" "all" "$BootDir\multiboot\$JustISOName\ubuntu.lst" 
	   ${ElseIf} ${FileExists} "$BootDir\multiboot\$JustISOName\vmlinuz"
	   !insertmacro ReplaceInFile "VLUG" "vmlinuz fsck.mode=skip" "all" "all" "$BootDir\multiboot\$JustISOName\ubuntu.lst"   
	   ${EndIf}  
	 ...
	 RMDir /R "$EXEDIR\TEMPYUMI"
	 ${WriteToFile} "#start $JustISOName$\r$\nLABEL Kon-Boot ($JustISOName)$\r$\nMENU LABEL Kon-Boot ($JustISOName)$\r$\nMENU INDENT 1$\r$\nKERNEL /multiboot/grub.exe$\r$\nAPPEND --config-file=root (hd0,0);configfile /multiboot/$JustISOName/konboot.lst" $R0 
	 ...
	 ; Windows Defender Offline
		 ...
		 CopyFiles $ISOFile "$BootDir\multiboot\ISOS\$JustISO" 
		 ; ${WriteToFile} "#start $JustISOName$\r$\nLABEL Windows Defender Offline ($JustISOName)$\r$\nMENU LABEL Windows Defender Offline ($JustISOName)$\r$\nMENU INDENT 1$\r$\nLINUX /multiboot/grub.exe$\r$\nAPPEND --config-file=root (hd0,0);configfile $\"ls /multiboot/ISOS/$JustISO || find --set-root /multiboot/ISOS/$JustISO;map --heads=0 --sectors-per-track=0 /multiboot/ISOS/$JustISO (0xff) || map --heads=0 --sectors-per-track=0 --mem /multiboot/ISOS/$JustISO (0xff);map --hook;chainloader (0xff)$\"$\r$\n#end $JustISOName" $R0
		 ${WriteToFile} "#start $JustISOName$\r$\nlabel Windows Defender Offline ($JustISOName)$\r$\nmenu label title Windows Defender Offline ($JustISOName)$\r$\nMENU INDENT 1$\r$\nKERNEL /multiboot/grub.exe$\r$\nAPPEND --config-file=root (hd0,0);configfile /multiboot/menu/WDO.lst$\r$\n#end $JustISOName" $R0   
	...
	; nsExec::ExecToLog '"DiskPart" /S $BootDir\multiboot\$JustISOName\diskpartdetach.txt' 
	 ...
	 CopyFiles $ISOFile "$BootDir\multiboot\ISOS\$JustISO"
	 ${WriteToFile} "#start $JustISOName$\r$\nlabel $JustISOName$\r$\nmenu label $JustISOName$\r$\nMENU INDENT 1$\r$\nKERNEL /multiboot/grub.exe$\r$\nAPPEND --config-file=root (hd0,0);configfile /multiboot/menu/sgd.lst$\r$\n#end $JustISOName" $R0   
	 ...
	 ${WriteToFile} "#start $JustISOName$\r$\ntitle Boot $JustISO$\r$\nmap (hd0) (hd1)$\r$\nmap (hd1) (hd0)$\r$\nmap --heads=0 --sectors-per-track=0 /multiboot/$JustISOName/$JustISOName.vhd (hd1)$\r$\nmap --hook$\r$\nchainloader (hd1)+1$\r$\nrootnoverify (hd1)$\r$\n#end $JustISOName" $R0    
		...
		; !insertmacro ReplaceInFile "SLUG" "$JustISO" "all" "all" "$BootDir\multiboot\menu\ubcd.lst"  
		 ...
		 ExecWait '"$PLUGINSDIR\7zG.exe" x "$ISOFile" -x![BOOT] -o"$BootDir\multiboot\$JustISOName\" -y'  
		 ${WriteToFile} "#start $JustISOName$\r$\nlabel $JustISOName$\r$\nmenu label $JustISOName$\r$\nMENU INDENT 1$\r$\nKERNEL /multiboot/grub.exe$\r$\nAPPEND --config-file=root (hd0,0);configfile /multiboot/$JustISOName/arcade.lst$\r$\n#end $JustISOName" $R0   
		 ...
		 ${ElseIf} $DistroName == "Super Grub2 Disk"  
		 ExecWait '"$PLUGINSDIR\7zG.exe" x "$ISOFile" -x![BOOT] -o"$BootDir\multiboot\$JustISOName\" -y'  
		 ${WriteToFile} "#start $JustISOName$\r$\nlabel $JustISOName$\r$\nmenu label $JustISOName$\r$\nMENU INDENT 1$\r$\nKERNEL /multiboot/grub.exe$\r$\nAPPEND --config-file=root (hd0,0);configfile /multiboot/$JustISOName/sgd.lst$\r$\n#end $JustISOName" $R0   
		 File /oname=$PLUGINSDIR\sgd.lst "Menu\sgd.lst"  
