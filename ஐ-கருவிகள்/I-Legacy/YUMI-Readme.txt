YUMI ©2021 https://www.pendrivelinux.com (covered under GNU GPL License) - see YUMI-Copying
...
12/16/20 Version 2.0.8.2: Added checkpoint for ubuntu partnew non persistent entry.
12/04/20 Version 2.0.8.1: Added back support for casper persistence on NTFS. Updated Grub4Dos version. Now using latest Nullsoft 3 compiler.
11/26/20 Version 2.0.8.0: Added back support for older Ubuntu and Linux Mint casper-rw persistence. Changed Max persistence file size creation for NTFS partitions to 20GB.
