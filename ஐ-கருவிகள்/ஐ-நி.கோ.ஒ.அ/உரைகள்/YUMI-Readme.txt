YUMI UEFI (Your Universal Multiboot Integrator) ©2011-2020 https://www.pendrivelinux.com (covered under GNU GPL License) - see YUMI-Copying
...
YUMI UEFI utilizes a Grub2 MBR to make the chosen drive bootable for Legacy BIOS booting. For UEFI booting GRUB is also nativaly used. Distribution ISO files are copied directly or extracted using 7zip to the multiboot folder on the USB device. Configuration files are used to house the menus used to boot each distribution. 
...
* Modified version of GRUB2 © A1ive https://github.com/a1ive/grub (unmodified source used)
* Grub2 File Manager © A1ive https://github.com/a1ive/grub2-filemanager (Modified for use with YUMI - EXFAT mode)
...
12/15/20 Version 0.0.3.3: Major rewrite to use exFAT filesystems. This version onward is not compatible with previous versions.
11/27/20 Version 0.0.3.2: Updated to create an Ubuntu/Linux-Mint persistence casper-rw/writable file/label based on the ISO name. Supports persistent feature for Linux Mint/Ubuntu version 16 through 20+. Added feature to check for Legacy YUMI.
