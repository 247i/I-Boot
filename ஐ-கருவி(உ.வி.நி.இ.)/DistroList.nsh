...
Function SetISOFileName ; Distro2Check (Name of the Distro), ISO2Check2 (The ISO File name before extraction), Download2Get (Download Link), Path2Name (Final destination/Name of File), GimmeSize (Size of the File), Config2Use (Config File to Write To), File2Check (file to check for before adding Menu entry), Homepage, OfficialName
 ...
 !insertmacro SetISOFileNames "CentOS Live" "CentOS*LIVE*.iso" "http://mirrors.mit.edu/centos/7/isos/x86_64/CentOS-7-x86_64-LiveGNOME-2003.iso" "NULL" "linux.cfg" "https://www.centos.org" "CentOS"
 !insertmacro SetISOFileNames "CentOS Minimal" "CentOS*Minimal*.iso" "http://mirrors.mit.edu/centos/8/isos/x86_64/CentOS-8.2.2004-x86_64-minimal.iso" "NULL" "linux.cfg" "https://www.centos.org" "CentOS"
 ...
 !insertmacro SetISOFileNames "Puppy Linux" "*pup*.iso" "http://distro.ibiblio.org/puppylinux/puppy-fossa/fossapup64-9.5.iso" "NULL" "linux.cfg" "puppylinux.com" "Puppy Linux" 	 
 ...
 !insertmacro SetISOFileNames "xPUD (Netbook Distro)" "openwebos*.iso" "https://storage.googleapis.com/google-code-archive-downloads/v2/code.google.com/xpud/openwebos-desktop-1005.iso" "NULL" "netbook.cfg" "http://www.xpud.org" "xPud"
     ...
     !insertmacro SetISOFileNames "--- Other Distros 32/64 இருமம் ---" "" "" "" "" "" ""
...
;Discontinued !insertmacro SetISOFileNames "SalineOS" "SalineOS*.iso" "http://www.salineos.com/server/SalineOS-1.0-i386-PSE.iso" "NULL" "linux.cfg" "http://www.salineos.com" "SalineOS"
 ...
 !insertmacro SetISOFileNames "AVIRA AntiVir Rescue CD (Virus Scanner)" "*escue-system.iso" "https://www.avira.com/en/downloads#tab_a3_0" "NULL" "antivirus.cfg" "http://www.avira.com" "Avira"
...
; REVISIT !insertmacro SetISOFileNames "Norton Bootable Recovery Tool" "nbrt*.iso" "https://us.norton.com/support/tools/nbrt.html" "NULL" "antivirus.cfg" "https://us.norton.com/support/tools/nbrt.html" "Norton"
